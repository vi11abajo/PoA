...
const GAME_CONFIG = {
    // 🦀 НАСТРОЙКИ КРАБОВ
    CRAB_SPEED: 80,        // Скорость движения крабов в % (50 = медленнее, 150 = быстрее)
    CRAB_FIRE_RATE: 80,    // Частота стрельбы крабов в % (50 = реже, 200 = чаще)
    CRAB_BULLET_SPEED: 90, // Скорость пуль крабов в % (80 = медленнее, 120 = быстрее)
    
    // 🐙 НАСТРОЙКИ ИГРОКА
    PLAYER_LIVES: 5,        // Количество жизней (1-10)
    PLAYER_SPEED: 110,      // Скорость движения игрока в % (50 = медленнее, 150 = быстрее)
    PLAYER_FIRE_RATE: 100,  // Скорость стрельбы игрока в % (50 = медленнее, 200 = быстрее)
    PLAYER_BULLET_SPEED: 110, // Скорость пуль игрока в % (80 = медленнее, 150 = быстрее)
    ...
    // 💰 БЛОКЧЕЙН НАСТРОЙКИ
    GAME_FEE: '0.000999',      // Комиссия за старт игры в PHRS (например: '0.001', '0.005', '0.01')
...
// 🟢 ЛЕГКИЙ РЕЖИМ:
// CRAB_SPEED: 80, CRAB_FIRE_RATE: 70, PLAYER_LIVES: 5, SCORE_MULTIPLIER: 120, GAME_FEE: '0.0005'
